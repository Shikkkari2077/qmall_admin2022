...
import DeliveryTypeAdd from "./DeliveryTypeAdd";
import Constant from "../../Constant";

class DeliveryTypeAddTab extends React.Component {
  state = {};
              ...
              <div className="col-lg-8">
                <div className="page-header-title">
                  <div className="d-inline">
                    <h4>{this.props.match.params.delivery_type_id ? "Edit" : "Add"}{" "} Delivery Type</h4>
                  </div>
                </div>
              </div>
                ...
                <div className="page-header-breadcrumb">
                  <ul className="breadcrumb-title">
                    ...
                    <li className="breadcrumb-item active">
                      {this.props.match.params.delivery_type_id ? "Edit" : "Add"}{" "} Delivery Type
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <div className="card-block">
                    ...
                    <div className="tab-content tabs">
                      <div className="tab-pane  active"
                        ...
                        {
                          this.state.delivery_type_id !== undefined &&
                            this.state.delivery_type_id !== null &&
                            this.state.delivery_type_id !== 0 &&
                            this.state.delivery_type_id !== ''
                            ?
                            <DeliveryTypeAdd language_id={this.state.language_id}
...
export default DeliveryTypeAddTab;