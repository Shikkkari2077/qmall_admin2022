...
class AttributeValueAddTab extends React.Component {
  ...
  componentDidMount() {
    if (this.props.match.params.attribute_value_id !== undefined && 
      this.props.match.params.attribute_value_id !== null && 
              ...
              <div className="col-lg-8">
                <div className="page-header-title">
                  <div className="d-inline">
                    <h4>{this.props.match.params.attribute_value_id ? "Edit" : "Add"}{" "} Attribute Value</h4>
                  </div>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="page-header-breadcrumb">
                  <ul className="breadcrumb-title">
                    ...
                    <li className="breadcrumb-item">
                      <Link to={"/attribute-values/"+this.props.match.params.attribute_type_id+"/"+this.props.match.params.attribute_id}>
