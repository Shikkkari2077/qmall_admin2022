                ...
                <div className="col-lg-8">
                  <div className="page-header-title">
                    <div className="d-inline">
                      <h4>Shop Address List</h4>
                    </div>
                  </div>
                  <Link to={"/shops/" + this.props.match.params.shop_id + "/branch/" + this.props.match.params.branch_id + "/address/add"} className="btn btn-sm btn-inverse waves-effect waves-light f-right d-inline-block md-trigger" data-modal="modal-13"> <i className="icofont icofont-plus m-r-5"></i> Add Shop Address </Link>
                </div>
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item">
                        <Link to={"/shops/branch/" + this.props.match.params.shop_id}>Branch List</Link>
                      </li>
                      <li className="breadcrumb-item active">Shop Address List</li>
                    </ul>
                  </div>
                </div>
              </div>
                      ...
                      <div className="col-md-4" key={address.id}>
                        <div className={address.isPrimary ? "card bg-light" : "card"}>
                          ...
                          <div className="card-block">
                            ...
                            {address.Area !== undefined && address.Area !== null && address.Area !== "" ? address.Area.name : ""}
                              <br />
