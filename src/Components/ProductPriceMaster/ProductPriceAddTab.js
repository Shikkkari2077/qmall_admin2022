...
class ProductPriceAddTab extends React.Component {
  state = {};
              ...
              <div className="col-lg-8">
                <div className="page-header-title">
                  <div className="d-inline">
                    <h4>{this.props.match.params.price_id ? "Edit" : "Add"}{" "} Product Price</h4>
                  </div>
                </div>
              </div>
                ...
                <div className="page-header-breadcrumb">
                  <ul className="breadcrumb-title">
                    ...
                    <li className="breadcrumb-item active">
                      {this.props.match.params.price_id ? "Edit" : "Add"}{" "} Product Price
                    </li>
                  </ul>
                </div>
              </div>
                  ...
                  <div className="card-block">
                    ...
                    <div className="tab-content tabs">
                      <div className="tab-pane  active"
                        ...
                        {
                          this.state.price_id !== undefined &&
                            this.state.price_id !== null &&
                            this.state.price_id !== 0 &&
                            this.state.price_id !== ''
                            ?
                            <ProductPriceAdd language_id={this.state.language_id} stock_id={this.props.match.params.stock_id} product_id={this.props.match.params.product_id} goBack={this.props.history.goBack} price_id={this.state.price_id} />
                            :
                            <ProductPriceAdd language_id={this.state.language_id} stock_id={this.props.match.params.stock_id} product_id={this.props.match.params.product_id} goBack={this.props.history.goBack} status={"add"} />
                        }
...
export default ProductPriceAddTab;
